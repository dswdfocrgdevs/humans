# Generated by Django 4.2.16 on 2025-01-21 06:31
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('hired_req', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='rsp.hiredreq')),
            ],
            options={
        ...
        migrations.AddField(
            model_name='hiredreq',
            name='empstatus',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='rsp.rspempstatus'),
        ),
    ]
